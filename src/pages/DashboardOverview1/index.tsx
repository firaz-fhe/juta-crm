...
export const updateMonthlyAssignments = async (employeeName: string, incrementValue: number) => {
  try {
    ...
    const userResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/user-data/${userEmail}`, {
      headers: {
    ...
    await axios.post('https://raucous-joaquin-unexamining.ngrok-free.dev/api/employees/update-monthly-assignments', {
      companyId: companyId,
...
interface Tag {
  ...
  const fetchMonthlyTokens = async () => {
    try {
      const userEmail = localStorage.getItem('userEmail');
      if (!userEmail) return;
      const userRes = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/user-data/${userEmail}`);
      const companyId = userRes.data.company_id;
      const res = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/monthly-usage`);
  ...
  async function fetchConfigFromDatabase() {
   ...
   /*   const repliesResponse = await fetch(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/replies`, {
        method: 'GET',
        headers: { 
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('token')}`
  ...
  async function fetchEmployeeData(employeeId: string): Promise<Employee | null> {
    try {
      ...
      // Get employees data
      const employeesResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/employees-data/${companyId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
      ...
      const contactsResponse = await axios.get(
        `https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/contacts?email=${encodeURIComponent(userEmail)}`,
        {
          headers: {}
        }
      );
...
setEngagementScore(Number(newEngagementScore.toFixed(2)));
        ...
        if (companyId) {
          ...
          const loadAIDataFirst = async () => {
            try {
              ...
              const configResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/user-config?email=${encodeURIComponent(userEmail)}`, {
                headers: {
                  'Authorization': `Bearer ${localStorage.getItem('token')}`
                }
              });
  ...
  const fetchAvailableTags = async () => {
    ...
    try {
      ...
      // Get tags data
      const tagsResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/tags`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const fetchBlastMessageData = async () => {
    try {
      ...
      const userRes = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/user-data/${userEmail}`);
      const companyId = userRes.data.company_id;
      const res = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/scheduled-messages-summary`);
  ...
  async function fetchCompanyData() {
    try {
      ...
      const dashboardRes = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/dashboard/${companyId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
      ...
      try {
        const companyRes = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/company-config/${companyId}`);
    ...
    try {
      ...
      while (retryCount <= maxRetries) {
        try {
          ...
          const dashboardResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/dashboard/${companyId}`, {
            headers: {
              'Authorization': `Bearer ${localStorage.getItem('token')}`
            },
      ...
      try {
        const activityResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/recent-activity`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
      ...
      try {
        const performanceResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/performance-metrics`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
  ...
  const fetchEmployeeAssignments = async (companyId: string, userEmail: string) => {
    try {
      ...
      try {
        const assignmentsResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/assignments/${companyId}`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
    ...
    try {
      ...
      try {
        const response = await axios.get(
          `https://raucous-joaquin-unexamining.ngrok-free.dev/api/stats/${companyId}?employeeId=${employeeId}`,
          {
            headers: {
              'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
  ...
  const fetchContactsForPeriod = async (periodStart: Date, periodEnd: Date) => {
    try {
      ...
      // Get contacts data
      const contactsResponse = await axios.get(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/companies/${companyId}/contacts`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const assignContactToEmployee = async (contactId: string, employeeName: string) => {
    try {
      ...
      await axios.post(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/contacts/${companyId}/${contactId}/tags`, {
        tags: [employeeName]
      }, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
  ...
  const removeContactAssignment = async (contactId: string, employeeName: string) => {
    try {
      ...
      await axios.delete(`https://raucous-joaquin-unexamining.ngrok-free.dev/api/contacts/${companyId}/${contactId}/tags`, {
